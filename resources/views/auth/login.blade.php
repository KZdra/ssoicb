<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-4">
            ...
            <input id="username" class="form-control form-control-lg @error('username') is-invalid @enderror" type="text" name="username" value="{{ old('username') }}" required autofocus autocomplete="username" placeholder="">
            @error('username')
