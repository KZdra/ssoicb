            ...
            <form action="{{ route('admin.clients.update', $client->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="name" class="form-label">application_name <span class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="redirect" class="form-label">redirect_uri <span class="text-danger">*</span></label>
                        <input type="url" class="form-control @error('redirect') is-invalid @enderror" id="redirect" name="redirect" value="{{ old('redirect', is_array($client->redirect_uris) && count($client->redirect_uris) > 0 ? $client->redirect_uris[0] : ($client->redirect ?? '')) }}" required placeholder="https://app.example.com/callback">
